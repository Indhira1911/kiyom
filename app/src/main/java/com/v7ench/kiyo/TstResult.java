...
ListView tst=null;
    ...
    public static final String CONTENTT = "content";
    @Override
    ...
    private void ReadDataFromDB(String uid) {
        ...
        String ur = "http://vigneshintech.tk/kiyo/tstrescheck.php?uid=";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                                ...
                                adapter = new SimpleAdapter(getApplicationContext(), Item_List,R.layout.row_tst, from, to);
